...
def main():
    base_path = "./csv_files"
    train_data_path = f"{base_path}/train_dataset_with_zapsplat.csv"
    eval_data_path = f"{base_path}/eval_dataset_with_zapsplat.csv"
    #train_data_path = f"{base_path}/train_epidemic_dataset.csv"
